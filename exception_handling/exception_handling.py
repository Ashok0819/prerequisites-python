...
# Case 2
# Loading a data_set but what if data_set does not exist or incorrect path has
# been given
...
def load_dataset(data_set):
    try:
        ...
        print('The File to be loaded does not exist')
        print(f_e)
...
if __name__ == '__main__':
    ...
    load_dataset('dataset.csv') # Case 2 Execution starts 
